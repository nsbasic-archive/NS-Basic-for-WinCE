...
END_COM_MAP()
	...
	HRESULT _StartAsyncDownload(BSTR bstrURL, IUnknown* pUnkContainer, long lRelative) {
		m_dwTotalRead = 0;
	...
	HRESULT StartAsyncDownload( T*                      pT,
		...
		HRESULT hr = _StartAsyncDownload(bstrURL, pUnkContainer, lRelative);
	...
	static HRESULT Download(    T*                      pT, 
		...
		return pbsc->StartAsyncDownload(pT, pFunc, pProgress, bstrURL, NULL, pUnkContainer, lRelative,NULL,FALSE,CP_ACP,punkHold,dwID,nBindf);
	}
    ...
    static HRESULT PostForm(    T*                      pT,
        ...
        CComVariant     v;
        v = bstrData;
        return pbsc->StartAsyncDownload(pT, pFunc, pProgress, bstrURL, L"POST", pUnkContainer, lRelative,&v,TRUE,CP_ACP,punkHold,dwID);
    }
    static HRESULT CustomOperation( T*                      pT,
		...
		return pbsc->StartAsyncDownload(pT,pFunc,pProgress,bstrURL,bstrVerb,pUnkContainer,lRelative,&vData,bFormPost,uCP,punkHold,dwID,nBindFlags,pFuncPermit);
    }
