...
SET OUTPUTPATH=e:\NSBCE6\Controls\NSBWin32\Binaries

REM SDK NAMES
 SET DLLNAME=NSBWin32.dll
...
%VC% CE4.VCW /MAKE "CE4 - Win32 (WCE ARMV4) ARMV4_Common" /CLEAN /CEConfig="%POCKETPC_2003_SDK%" /REBUILD 1 >> ..\compileErr.txt
...
%VC% CE4.VCW /MAKE "CE4 - Win32 (WCE ARMV4) CE42_ARMV4_Release" /CLEAN /CEConfig="%STD_SDK4%" /REBUILD 1 >> ..\compileErr.txt
...
%VC% CE4.VCW /MAKE "CE4 - Win32 (WCE ARMV4I) CE42_ARM4I_Release" /CLEAN /CEConfig="%STD_SDK4%" /REBUILD 1 >> ..\compileErr.txt
...
%VC% CE4.VCW /MAKE "CE4 - Win32 (WCE emulator) CE42_EMU_Release" /CLEAN /CEConfig="%STD_SDK4%" /REBUILD 1 >> ..\compileErr.txt
...
%VC% CE4.VCW /MAKE "CE4 - Win32 (WCE MIPSII) CE42_MIPSII_Release" /CLEAN /CEConfig="%STD_SDK4%" /REBUILD 1 >> ..\compileErr.txt
...
%VC% CE4.VCW /MAKE "CE4 - Win32 (WCE MIPSII_FP) CE42_MIPSIIFP_Release" /CLEAN /CEConfig="%STD_SDK4%" /REBUILD 1 >> ..\compileErr.txt
...
%VC% CE4.VCW /MAKE "CE4 - Win32 (WCE MIPSIV) CE42_MIPSIV_Release" /CLEAN /CEConfig="%STD_SDK4%" /REBUILD 1 >> ..\compileErr.txt
...
%VC% CE4.VCW /MAKE "CE4 - Win32 (WCE MIPSIV_FP) CE42_MIPSIVFP_Release" /CLEAN /CEConfig="%STD_SDK4%" /REBUILD 1 >> ..\compileErr.txt
...
%VC% CE4.VCW /MAKE "CE4 - Win32 (WCE SH3) CE42_SH3_Release" /CLEAN /CEConfig="%STD_SDK4%" /REBUILD 1 >> ..\compileErr.txt
...
%VC% CE4.VCW /MAKE "CE4 - Win32 (WCE SH4) CE42_SH4_Release" /CLEAN /CEConfig="%STD_SDK4%" /REBUILD 1 >> ..\compileErr.txt
...
%VC% CE4.VCW /MAKE "CE4 - Win32 (WCE x86) CE42_X86_Release" /CLEAN /CEConfig="%STD_SDK4%" /REBUILD 1 >> ..\compileErr.txt
...
%VC% Desk.dsw /MAKE "Desk - Win32 Unicode Release MinDependency" /CLEAN /REBUILD 1 >> ..\compileErr.txt
