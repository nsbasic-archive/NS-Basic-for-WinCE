...
SET EVC3="J:\Program Files\Microsoft eMbedded Tools\COMMON\EVC\bin\evc.exe"
SET EVC4="J:\Program Files\Microsoft eMbedded C++ 4.0\COMMON\EVC\bin\evc.exe"
SET MSVC6="J:\Program Files\Microsoft Visual Studio\Common\MSDev98\Bin\MSDEV.EXE"
SET OUTPUTPATH=G:\WORKS\WindowsNT\atl\NSBasic\COMDLG\prj\Binaries

REM SDK NAMES
 SET DLLNAME=NSBComDlg.dll
...
%VC% EVC4.VCW /MAKE "EVC4 - Win32 (WCE ARMV4) CE42_ARMV4_Release" /CLEAN /CEConfig="%POCKETPC_2003_SDK%" /REBUILD 1 >> ..\compileErr.txt
...
%VC% EVC4.VCW /MAKE "EVC4 - Win32 (WCE ARMV4) CE42_ARMV4_Release" /CLEAN /CEConfig="%STD_SDK4%" /REBUILD 1 >> ..\compileErr.txt
...
%VC% EVC4.VCW /MAKE "EVC4 - Win32 (WCE ARMV4I) CE42_ARMV4I_Release" /CLEAN /CEConfig="%STD_SDK4%" /REBUILD 1 >> ..\compileErr.txt
