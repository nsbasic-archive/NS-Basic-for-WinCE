...
BEGIN_DISPATCH_MAP(CNSCEPictureBoxCtrl, COleControl)
	...
	DISP_PROPERTY_EX(CNSCEPictureBoxCtrl, "resourceBitmapIDstr", GetResourceBitmapIDstr, SetResourceBitmapIDstr, VT_BSTR)
	...
	DISP_FUNCTION_ID(CNSCEPictureBoxCtrl, "Refresh", DISPID_REFRESH, MethodRefreshX, VT_EMPTY, VTS_NONE)
	//}}AFX_DISPATCH_MAP
...
CNSCEPictureBoxCtrl::CNSCEPictureBoxCtrl()
{
	...
	//2009.11.24 GWH This doesn't look right. Due to integer arithmetic, the result gets
	//rounded. Anyhow, the result is used just in the scaling routines. I don't think they work either.
	if (m_versionInfo.dwMajorVersion >= 5) 
	{	
		m_nLogPixelsX /= m_nLogPixelsX / 72; 
		m_nLogPixelsY /= m_nLogPixelsY / 72;
	}
#endif
...
//										AfxMessageBox(strMessage);
	...
	if (m_nResourceID >= 0)
	{
		if (m_hInstance == NULL)
		{
			...
			m_hResourceFile = GetModuleHandle(m_strResourceFile);
			...
			if (m_hResourceFile == NULL)
			{
				wsprintf(szMessage, TEXT("LoadLibrary: GetLastError() = %d"), nLastError);
		...
		else
		{
			if (m_hInstance != NULL)
			{
				if (m_nResourceID != 0xFFFFFFF)
				{
					hLoadBitmap = (HBITMAP)::LoadImage(m_hInstance,MAKEINTRESOURCE(m_nResourceID), IMAGE_BITMAP, 0, 0, 0);
				}
				else
				{
					hLoadBitmap = (HBITMAP)::LoadImage(m_hInstance,m_strResourceID, IMAGE_BITMAP, 0, 0, 0);
...
{
	HDC dcNew = ::CreateCompatibleDC(NULL);
	long dpi = ::GetDeviceCaps(dcNew,LOGPIXELSY);
	double screenY = ::GetSystemMetrics(SM_CYSCREEN);
	double realScreenY = ::GetDeviceCaps(dcNew,VERTRES);

	long nReturn = (long)((-1.0 * ((double)(m_LogFont.lfHeight * 72) / (double)(dpi) * (double)(realScreenY / screenY))) + 0.5);
	::DeleteDC(dcNew);
	return nReturn;
}
...
void CNSCEPictureBoxCtrl::SetFontSize(long nNewValue) 
{
	...
	double screenY = ::GetSystemMetrics(SM_CYSCREEN);
	double realScreenY = ::GetDeviceCaps(dcNew,VERTRES);
	//calculate height of characters - depends on dpi setting
	//then scale to screen if it is in hi res mode.
	m_LogFont.lfHeight = -1 * (long)(((double)(nNewValue * dpi) / 72.0) * (double)(screenY / realScreenY) + 0.5);

	::DeleteDC(dcNew);

	//if (nNewValue == 9) {
	//	CString str;
	//	str.Format(TEXT("lfHeight=%d"), m_LogFont.lfHeight);
	//	AfxMessageBox(str);
	//}
#endif // UNDER_CE
...
void CNSCEPictureBoxCtrl::SetAnimationInterval(long nNewValue) 
{
	...
	{
		ThrowError(CTL_E_INVALIDPROPERTYVALUE, TEXT("AnimationInterval"), 0);
	}
	else
	{
...
void CNSCEPictureBoxCtrl::SetAppearance(short nNewValue) 
{
	...
	{
		ThrowError(CTL_E_INVALIDPROPERTYVALUE, TEXT("Appearance"), 0);
	}
	else
	{
...
void CNSCEPictureBoxCtrl::SetCenter(short nNewValue) 
{
	...
	{
		ThrowError(CTL_E_INVALIDPROPERTYVALUE, TEXT("Center"), 0);
	}
	else
	{
		m_nCenter = nNewValue;
...
void CNSCEPictureBoxCtrl::SetCommonBitmapID(short nNewValue) 
{
	...
	{
		ThrowError(CTL_E_INVALIDPROPERTYVALUE, TEXT("CommonBitmapID"), 0);
		return;
	}
*/
...
void CNSCEPictureBoxCtrl::SetCommonBitmapType(short nNewValue) 
{
	...
	{
		ThrowError(CTL_E_INVALIDPROPERTYVALUE, TEXT("BitmapType"), 0);
	}
	else
	{
		CommonClearForLoad();
...
BOOL CNSCEPictureBoxCtrl::MethodDrawIcon(LPCTSTR szFile, const VARIANT FAR& vIconID, const VARIANT FAR& vLarge, const VARIANT FAR& vocColor, const VARIANT FAR& vDrawType) 
{
	...
	if (NULL != hIcon)
	{
		...
		{
			ThrowError(CTL_E_INVALIDPROPERTYVALUE, TEXT("DrawIcon"), 0);
		}
		else
		{
			m_bDisplayExpired = TRUE;
...
void CNSCEPictureBoxCtrl::MethodDrawPolygon(short nPoints, const VARIANT FAR& vocColor) 
{
	...
	{
		ThrowError(CTL_E_INVALIDPROPERTYVALUE, TEXT("DrawPolygon"), 0);
	}
	else
	{
		if (NULL != m_ptPointArray)
...
void CNSCEPictureBoxCtrl::MethodDrawPolyLines(short nPoints, const VARIANT FAR& vocColor) 
{
	if ((nPoints < 2) || (nPoints > m_nPointArraySize))
	{
		ThrowError(CTL_E_INVALIDPROPERTYVALUE, TEXT("DrawPolyLines"), 0);
	}
	else
	{
		if (NULL != m_ptPointArray)
...
void CNSCEPictureBoxCtrl::SetDrawWidth(long nNewValue) 
{
	if (nNewValue < 1)
	{
		ThrowError(CTL_E_INVALIDPROPERTYVALUE, TEXT("DrawWidth"), 0);
	}
	else
	{
...
void CNSCEPictureBoxCtrl::SetFillStyle(short nNewValue) 
{
	if ((nNewValue < 0) || (nNewValue > 1))
	{
		ThrowError(CTL_E_INVALIDPROPERTYVALUE, TEXT("FillStyle"), 0);
	}
	else
	{
...
*/
			...
			default:
			{
				ThrowError(CTL_E_INVALIDPROPERTYVALUE, TEXT("ImageBitsPerPixel"), 0);
				break;
			}
		}
	}
...
void CNSCEPictureBoxCtrl::SetImageLoadBitsPerPixel(short nNewValue) 
{
	switch (nNewValue)
	{
		...
		default:
		{
			ThrowError(CTL_E_INVALIDPROPERTYVALUE, TEXT("ImageLoadBitsPerPixel"), 0);
			break;
		}
	}
}
...
void CNSCEPictureBoxCtrl::SetImageLoadBufferSize(long nNewValue) 
{
	if (nNewValue < -1)
	{
		ThrowError(CTL_E_INVALIDPROPERTYVALUE, TEXT("ImageLoadBufferSize"), 0);
	}
	else
	{
...
void CNSCEPictureBoxCtrl::SetImageLoadMaxHeight(long nNewValue) 
{
	if (nNewValue < 1)
	{
		ThrowError(CTL_E_INVALIDPROPERTYVALUE, TEXT("ImageLoadMaxHeight"), 0);
	}
	else
	{
...
void CNSCEPictureBoxCtrl::SetImageLoadMaxWidth(long nNewValue) 
{
	if (nNewValue < 1)
	{
		ThrowError(CTL_E_INVALIDPROPERTYVALUE, TEXT("ImageLoadMaxWidth"), 0);
	}
	else
	{
...
void CNSCEPictureBoxCtrl::SetImageLoadScalePercent(long nNewValue) 
{
	...
	{
		ThrowError(CTL_E_INVALIDPROPERTYVALUE, TEXT("ImageLoadScalePercent"), 0);
	}
	else
	{
...
void CNSCEPictureBoxCtrl::SetMirror(short nNewValue) 
{
	if ((nNewValue < 0) || (nNewValue > 3))
	{
		ThrowError(CTL_E_INVALIDPROPERTYVALUE, TEXT("Mirror"), 0);
	}
	else
	{
		m_nMirror = nNewValue;
...
void CNSCEPictureBoxCtrl::SetMouseMovePoints(short nNewValue) 
{
	...
	{
		ThrowError(CTL_E_INVALIDPROPERTYVALUE, TEXT("MouseMovePoints"), 0);
	}
	else
	{
...
void CNSCEPictureBoxCtrl::SetOverlayTop(long nNewValue) 
{
	if (nNewValue < 0)
	{
		ThrowError(CTL_E_INVALIDPROPERTYVALUE, TEXT("OverlayTop"), 0);
	}
	else
	{
...
void CNSCEPictureBoxCtrl::SetOverlayLeft(long nNewValue) 
{
	if (nNewValue < 0)
	{
		ThrowError(CTL_E_INVALIDPROPERTYVALUE, TEXT("OverlayLeft"), 0);
	}
	else
	{
...
void CNSCEPictureBoxCtrl::SetPenFillStyle(short nNewValue) 
{
	if ((nNewValue < 0) || (nNewValue > 1))
	{
		ThrowError(CTL_E_INVALIDPROPERTYVALUE, TEXT("PenFillStyle"), 0);
	}
	else
	{
...
void CNSCEPictureBoxCtrl::SetPenStyle(short nNewValue) 
{
	if ((nNewValue < 0) || (nNewValue > 2))
	{
		ThrowError(CTL_E_INVALIDPROPERTYVALUE, TEXT("PenStyle"), 0);
	}
	else
	{
...
OLE_COLOR CNSCEPictureBoxCtrl::GetPixel(long nX, long nY) 
{
	...
	{
		ThrowError(CTL_E_INVALIDPROPERTYVALUE, TEXT("Pixel"), 0);
	}
	else
	{
		HDC dcNew = ::CreateCompatibleDC(NULL);
...
void CNSCEPictureBoxCtrl::SetPlayingCard(short nNewValue) 
{
	...
	if (m_hInstance == NULL)
	{
		...
		{
			m_nResourceID = -1;
			ThrowError(CTL_E_INVALIDPROPERTYVALUE, TEXT("PlayingCard"), 0);
		}
	}
	else
	{
...
OLE_COLOR CNSCEPictureBoxCtrl::MethodRGB(short nRed, short nGreen, short nBlue) 
{
	...
	{
		ThrowError(CTL_E_INVALIDPROPERTYVALUE, TEXT("RGB"), 0);
		return RGB(0, 0, 0);
	}
	else
	{
...
OLE_COLOR CNSCEPictureBoxCtrl::MethodQBColor(short nColorCode) 
{
	...
	{
		ThrowError(CTL_E_INVALIDPROPERTYVALUE, TEXT("QBColor"), 0);
		return RGB(0, 0, 0);
	}
	else
	{
...
void CNSCEPictureBoxCtrl::SetResizeHeight(long nNewValue) 
{
	if (nNewValue < 0)
	{
		ThrowError(CTL_E_INVALIDPROPERTYVALUE, TEXT("ResizeHeight"), 0);
	}
	else
	{
...
void CNSCEPictureBoxCtrl::SetResizeWidth(long nNewValue) 
{
	if (nNewValue < 0)
	{
		ThrowError(CTL_E_INVALIDPROPERTYVALUE, TEXT("ResizeWidth"), 0);
	}
	else
	{
...
void CNSCEPictureBoxCtrl::SetResourceIconHeight(long nNewValue) 
{
	if (0 > nNewValue)
	{
		ThrowError(CTL_E_INVALIDPROPERTYVALUE, TEXT("ResourceIconHeight"), 0);
	}
	else
	{
...
void CNSCEPictureBoxCtrl::SetResourceIconWidth(long nNewValue) 
{
	if (0 > nNewValue)
	{
		ThrowError(CTL_E_INVALIDPROPERTYVALUE, TEXT("ResourceIconWidth"), 0);
	}
	else
	{
...
void CNSCEPictureBoxCtrl::SetRotate(short nNewValue) 
{
	...
	{
		ThrowError(CTL_E_INVALIDPROPERTYVALUE, TEXT("Rotate"), 0);
	}
	SetModifiedFlag();
}
...
void CNSCEPictureBoxCtrl::SetScrollBars(short nNewValue) 
{
	if ((nNewValue < 0) || (nNewValue > 3))
	{
		ThrowError(CTL_E_INVALIDPROPERTYVALUE, TEXT("Scrollbars"), 0);
	}
	else
	{
...
void CNSCEPictureBoxCtrl::MethodSetPointArray(long nIndex, float x, float y) 
{
	if (nIndex < 1)
	{
		ThrowError(CTL_E_INVALIDPROPERTYVALUE, TEXT("PointArray"), 0);
	}
	else
	{
...
void CNSCEPictureBoxCtrl::SetTag(const VARIANT FAR& newValue) 
{
	if (!AmbientUserMode())
	{
		ThrowError(CTL_E_INVALIDPROPERTYVALUE, TEXT("Tag"), 0);
	}
	else
	{
...
void CNSCEPictureBoxCtrl::SetWildCard(short nNewValue) 
{
	if ((nNewValue < 0) && (nNewValue > 3))
	{
		ThrowError(CTL_E_INVALIDPROPERTYVALUE, TEXT("WildCard"), 0);
	}
	else
	{
...
void CNSCEPictureBoxCtrl::SetHBitmap(long nNewValue) 
{
	...
	{
		ThrowError(CTL_E_INVALIDPROPERTYVALUE, TEXT("hBitmap"), 0);
	}
...
void CNSCEPictureBoxCtrl::SetHIcon(long nNewValue) 
{
	...
	if (NULL == hIcon)
	{
		ThrowError(CTL_E_INVALIDPROPERTYVALUE, TEXT("hIcon"), 0);
		return;
	}
...
void CNSCEPictureBoxCtrl::SetHFont(long nNewValue) 
{
	...
	{
		ThrowError(CTL_E_INVALIDPROPERTYVALUE, TEXT("hFont"), 0);
	}
}
...
BSTR CNSCEPictureBoxCtrl::GetResourceBitmapIDstr() 
{
	CString strResult;
	strResult = m_strResourceBitmapID;
	return strResult.AllocSysString();
}

void CNSCEPictureBoxCtrl::SetResourceBitmapIDstr(LPCTSTR lpszNewValue) 
{
	CString strResourceFile;
	...
	m_strResourceBitmapID = lpszNewValue;
	m_strResourceID = m_strResourceBitmapID;
	m_nResourceBitmapID = 0xFFFFFFF;
	m_nResourceID = m_nResourceBitmapID;
	SetModifiedFlag();
