...
public:
	...
	dispidResizeImage = 149L,
	dispidRotateImage = 150L,
	dispidSaveImageToFile = 151L,
	dispidScrollImage = 152L,
	dispidSetFocus = 153L,
	dispidSetPointArray = 154L,
	dispidTextWidth = 155L,
	dispidTextHeight = 156L,
	dispidURL = 157L,
	dispidZOrder = 158L,
	eventidGotFocus = 1L,
	eventidHScroll = 2L,
