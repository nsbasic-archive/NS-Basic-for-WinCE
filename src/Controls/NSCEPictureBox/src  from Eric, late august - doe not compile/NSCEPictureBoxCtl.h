...
// Message maps
	...
	afx_msg int OnEnterMenuLoop(BOOL track);
	afx_msg int OnExitMenuLoop(BOOL track);
...
// Dispatch maps
	...
	afx_msg long GetParentHWnd();
	afx_msg void SetParentHWnd(long nNewValue);
...
public:
	...
	dispidReleaseCapture = 148L,
	dispidRefreshX = 149L,
	dispidResizeImage = 150L,
	dispidRotateImage = 151L,
	dispidSaveImageToFile = 152L,
	dispidScrollImage = 153L,
	dispidSetFocus = 154L,
	dispidSetPointArray = 155L,
	dispidTextWidth = 156L,
	dispidTextHeight = 157L,
	dispidURL = 158L,
	dispidZOrder = 159L,
	eventidGotFocus = 1L,
	eventidHScroll = 2L,
