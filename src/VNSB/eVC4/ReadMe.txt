========================================================================
     Microsoft Foundation Class Library for Windows CE: VNSB
========================================================================


AppWizard has created this VNSB application for you.  This application
not only demonstrates the basics of using the Microsoft Foundation classes
but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your VNSB application.

VNSB.h
    This is the main header file for the application.  It includes other
    project specific headers (including Resource.h) and declares the
    CVNSBApp application class.
...
res\VNSB.ico
    ...
    icon is included by the main resource file VNSB.rc.
...
VNSBDoc.h, VNSBDoc.cpp - the document
    These files contain your CVNSBDoc class.  Edit these files to
    add your special document data and to implement file saving and loading
    (via CVNSBDoc::Serialize).

VNSBView.h, VNSBView.cpp - the view of the document
    These files contain your CVNSBView class.
    CVNSBView objects are used to view CVNSBDoc objects.
...
StdAfx.h, StdAfx.cpp
    ...
    named VNSB.pch and a precompiled types file named StdAfx.obj.
