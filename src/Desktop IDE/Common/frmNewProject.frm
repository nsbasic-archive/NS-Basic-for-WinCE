   ...
   Begin MSComctlLib.ImageList imlTemplates 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmNewProject.frx":0C52
            Key             =   "NSBOrange"
            Object.Tag             =   "std"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmNewProject.frx":6874
            Key             =   "NSBGreen"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmNewProject.frx":C496
            Key             =   "NSBBlue"
            Object.Tag             =   "nul"
         EndProperty
      EndProperty
...
Dim itm As Object
   ...
   Set itm = lstTemplates.ListItems.Add(, , "Standard", "NSBGreen")
   itm.Tag = "std"
   Set itm = lstTemplates.ListItems.Add(, , "Formless", "NSBBlue")
   itm.Tag = "nul"
   LoadResStrings Me
End Sub
...
Dim itm As Object
   ...
   For Each itm In lstTemplates.ListItems
      If itm.Selected Then
         m_strTemplate = itm.Tag
         Exit For
      End If
   Next
   Unload Me
