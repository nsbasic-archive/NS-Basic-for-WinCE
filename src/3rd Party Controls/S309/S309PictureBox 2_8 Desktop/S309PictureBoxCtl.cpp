...
BEGIN_DISPATCH_MAP(CS309PictureBox, COleControl)
	...
	DISP_PROPERTY_EX(CS309PictureBox, "Version", GetVersion, SetNotSupported, VT_R4)
	...
	DISP_PROPERTY_EX(CS309PictureBox, "ByteArray", GetByteArray, SetByteArray, VT_VARIANT)
	DISP_PROPERTY_EX(CS309PictureBox, "TapAndHoldEventEnabled", GetTapAndHoldEventEnabled, SetTapAndHoldEventEnabled, VT_BOOL)
	DISP_PROPERTY_EX(CS309PictureBox, "PlayingCardsDll", GetPlayingCardsDll, SetPlayingCardsDll, VT_BSTR)
	DISP_PROPERTY_EX(CS309PictureBox, "VersionString", GetVersionString, SetNotSupported, VT_BSTR)
	DISP_PROPERTY_EX(CS309PictureBox, "Headers", GetHeaders, SetNotSupported, VT_BSTR)
	DISP_PROPERTY_EX(CS309PictureBox, "URLFlags", GetURLFlags, SetURLFlags, VT_I4)
	DISP_PROPERTY_EX(CS309PictureBox, "URLFlagPassive", GetURLFlagPassive, SetURLFlagPassive, VT_BOOL)
	DISP_PROPERTY_EX(CS309PictureBox, "URLFlagCache", GetURLFlagCache, SetURLFlagCache, VT_BOOL)
	DISP_PROPERTY_EX(CS309PictureBox, "URLFlagReload", GetURLFlagReload, SetURLFlagReload, VT_BOOL)
	DISP_PROPERTY_EX(CS309PictureBox, "URLAgent", GetURLAgent, SetURLAgent, VT_BSTR)
	DISP_PROPERTY_EX(CS309PictureBox, "ImageLoadScalePercent", GetImageLoadScalePercent, SetImageLoadScalePercent, VT_I4)
	DISP_PROPERTY_EX(CS309PictureBox, "FontEscapement", GetFontEscapement, SetFontEscapement, VT_I4)
	DISP_PROPERTY_EX(CS309PictureBox, "FontOrientation", GetFontOrientation, SetFontOrientation, VT_I4)
	DISP_PROPERTY_EX(CS309PictureBox, "hIcon", GetHIcon, SetHIcon, VT_I4)
	DISP_PROPERTY_EX(CS309PictureBox, "AutoDetectTransparency", GetAutoDetectTransparency, SetAutoDetectTransparency, VT_BOOL)
	DISP_PROPERTY_EX(CS309PictureBox, "ResourceIconHeight", GetResourceIconHeight, SetResourceIconHeight, VT_I4)
	DISP_PROPERTY_EX(CS309PictureBox, "ResourceIconWidth", GetResourceIconWidth, SetResourceIconWidth, VT_I4)
	...
	DISP_FUNCTION(CS309PictureBox, "StopUrlStream", MethodStopUrlStream, VT_EMPTY, VTS_NONE)
	DISP_FUNCTION(CS309PictureBox, "Data", MethodData, VT_EMPTY, VTS_VARIANT VTS_VARIANT)
	DISP_FUNCTION(CS309PictureBox, "URL", MethodURL, VT_I4, VTS_BSTR VTS_VARIANT VTS_VARIANT)
	DISP_FUNCTION(CS309PictureBox, "DrawTextInRect", MethodDrawTextInRect, VT_EMPTY, VTS_BSTR VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT)
...
// {281CE428-7111-4bf0-AEDC-37D2AA900204}
IMPLEMENT_OLECREATE_EX(CS309PictureBox, "S309.PictureBox.2.8",
	0x281ce428, 0x7111, 0x4bf0, 0xae, 0xdc, 0x37, 0xd2, 0xaa, 0x90, 0x2, 0x4)
...
// {C5620B0B-1CAB-4bce-B13B-D1072CE34BB0}
const IID BASED_CODE IID_DS309PictureBox =
		{ 0xc5620b0b, 0x1cab, 0x4bce, { 0xb1, 0x3b, 0xd1, 0x7, 0x2c, 0xe3, 0x4b, 0xb0 } };
//		{ 0xd4d7c4b7, 0x2cc5, 0x11d3, { 0xae, 0x29, 0, 0x60, 0x8c, 0xc1, 0xdd, 0x62 } };

// {9C86DD38-57D0-4a7a-B1D5-7A74F968EBE5}
const IID BASED_CODE IID_DS309PictureBoxEvents =
		{ 0x9c86dd38, 0x57d0, 0x4a7a, { 0xb1, 0xd5, 0x7a, 0x74, 0xf9, 0x68, 0xeb, 0xe5 } };
...
CS309PictureBox::CS309PictureBox()
{
	...
	m_dteExpire.SetDateTime(2999, 6, 30, 23, 59, 59);
	...
	m_strURLAgent = TEXT("Software 309 PictureBox");
...
//	if (AmbientUserMode())
//	{
//		AfxMessageBox(TEXT("This version S309 PictureBox Control is not allowed to be used as a run time control on the desktop."), MB_ICONERROR + MB_OK, 0);
//		return;
//	}
//#endif
			...
			else
			{
				...
				if ((m_bIsStretched) && (m_bStretch))
				{
					...
					else
					{
						...
						::TransparentBlt(pdc->GetSafeHdc(), nDestLeft, nDestTop, nDestWidth, nDestHeight, dcNew, nSourceLeft, nSourceTop, Bitmap.bmWidth, Bitmap.bmHeight, crTransparentColor);
...
//	PX_Bool( pPX, TEXT("Visible"), m_bVisible, TRUE);
	...
	PX_String(pPX, TEXT("URLAgent"), m_strURLAgent, TEXT("Software 309 PictureBox"));
...
//rotate				hBitmap = CommonGetBitmapRotated(m_hWorkingAnimationBitmap[i], nOffset);
				CS309Bitmap *pOld = new CS309Bitmap;
				if (NULL != pOld)
				{
					pOld->SetHBITMAP(m_hWorkingAnimationBitmap[i]);
					CS309Bitmap *pNew = pOld->Rotate(nOffset);
					if (NULL != pNew)
					{
...
BOOL CS309PictureBox::CommonLoadImageIntoBitmap()
{
	...
	if ((m_strPicture.GetLength() > 0) || (m_ByteArray != NULL) || (m_nResourceID >= 0) || (m_hWorkingIconBitmap != NULL) || (m_hWorkingBitmap != NULL) || (m_bWorkingCaptureScreen)) 
	{
		...
		if (m_dteDate > m_dteExpire)
		{
			...
			{
				AfxMessageBox(TEXT("The S309.PictureBox Control has expired.\nGoto http://nsbasic.com/s309"), MB_ICONERROR + MB_OK, 0);
...
void CS309PictureBox::MethodSetPointArray(long nIndex, long nX, long nY) 
{
	...
	else
	{
		...
		m_ptPointArray[nIndex - 1].x = nX;
		m_ptPointArray[nIndex - 1].y = nY;
		SetModifiedFlag();
	}
}
...
float CS309PictureBox::GetVersion() 
{
...
CString CS309PictureBox::CommonOptionalString(const VARIANT *vString, LPCTSTR lpszInit)
{
...
void CS309PictureBox::CommonDrawTextInRect(int nType, RECT *rect, LPCTSTR szText, OLE_COLOR ocColor)
{
	if (m_hBitmap == NULL)
	{
		m_hBitmap = CommonGetBitmapControlSize();
...
VARIANT CS309PictureBox::GetByteArray() 
{
	VARIANT vaResult;
	VariantInit(&vaResult);
	HRESULT bhr = NOERROR;
...
void CS309PictureBox::SetByteArray(const VARIANT FAR& newValue) 
{
	long lBound;
	long uBound;
	long index;
...
bool CS309PictureBox::CommonSaveImageToByteArray()
{
	BITMAPINFO *bih = NULL;
...
LRESULT CS309PictureBox::WindowProc(UINT message, WPARAM wParam, LPARAM lParam) 
{
	DWORD dwDataLength;
	CString strText;
...
void CS309PictureBox::MethodData(const VARIANT FAR& varData, const VARIANT FAR& varDataLength) 
{
...
BOOL CS309PictureBox::GetTapAndHoldEventEnabled() 
{
	return m_bTapAndHoldEventEnabled;
}

void CS309PictureBox::SetTapAndHoldEventEnabled(BOOL bNewValue) 
{
	m_bTapAndHoldEventEnabled = bNewValue;
	SetModifiedFlag();
}

long CS309PictureBox::StartURL(LPCTSTR lpszURL, LPCTSTR lpszUser,LPCTSTR lpszPassword) 
{
	long lReturn = 0;
...
void CS309PictureBox::MethodStopUrlStream() 
{
	CUrlImage *pUrlImage = m_pUrlImage;
	if (NULL != pUrlImage)
	{ 
...
long CS309PictureBox::MethodURL(LPCTSTR lpszURL, const VARIANT FAR& vUser, const VARIANT FAR& vPassword) 
{
	long lReturn = -1;
...
BSTR CS309PictureBox::GetPlayingCardsDll() 
{
	CString strResult;
...
void CS309PictureBox::SetPlayingCardsDll(LPCTSTR lpszNewValue) 
{
...
BSTR CS309PictureBox::GetVersionString() 
{
	CString strResult;
...
BSTR CS309PictureBox::GetHeaders() 
{
	CString strResult;
...
long CS309PictureBox::GetURLFlags() 
{
	return m_nURLFlags;
}

void CS309PictureBox::SetURLFlags(long nNewValue) 
{
	m_nURLFlags = nNewValue;
	SetModifiedFlag();
}

BOOL CS309PictureBox::GetURLFlagPassive() 
{
	return (INTERNET_FLAG_PASSIVE == (m_nURLFlags & INTERNET_FLAG_PASSIVE));
}

void CS309PictureBox::SetURLFlagPassive(BOOL bNewValue) 
{
...
BOOL CS309PictureBox::GetURLFlagCache() 
{
	return (INTERNET_FLAG_DONT_CACHE != (m_nURLFlags & INTERNET_FLAG_DONT_CACHE));
}

void CS309PictureBox::SetURLFlagCache(BOOL bNewValue) 
{
...
BOOL CS309PictureBox::GetURLFlagReload() 
{
	return (INTERNET_FLAG_RELOAD == (m_nURLFlags & INTERNET_FLAG_RELOAD));
}

void CS309PictureBox::SetURLFlagReload(BOOL bNewValue) 
{
...
BSTR CS309PictureBox::GetURLAgent() 
{
	CString strResult;
...
void CS309PictureBox::SetURLAgent(LPCTSTR lpszNewValue) 
{
	m_strURLAgent = lpszNewValue;
	SetModifiedFlag();
}

long CS309PictureBox::GetImageLoadScalePercent() 
{
	return m_nImageLoadScalePercent;
}

void CS309PictureBox::SetImageLoadScalePercent(long nNewValue) 
{
...
BOOL CS309PictureBox::PreCreateWindow(CREATESTRUCT& cs) 
{
#ifndef UNDER_CE
...
long CS309PictureBox::GetFontEscapement() 
{
	return m_LogFont.lfEscapement;
}

void CS309PictureBox::SetFontEscapement(long nNewValue) 
{
	CommonDestroyFont();
...
long CS309PictureBox::GetFontOrientation() 
{
	return m_LogFont.lfOrientation;
}

void CS309PictureBox::SetFontOrientation(long nNewValue) 
{
	CommonDestroyFont();
...
void CS309PictureBox::MethodDrawTextInRect(LPCTSTR Text, const VARIANT FAR& Left, const VARIANT FAR& Top, const VARIANT FAR& Width, const VARIANT FAR& Height, const VARIANT FAR& Color) 
{
	RECT rect;
	rect.left = CommonOptionalLong(&Left, 0);
	rect.right = rect.left + CommonOptionalLong(&Width, GetWidth());
	rect.top = CommonOptionalLong(&Top, 0);
	rect.bottom = rect.top + CommonOptionalLong(&Height, GetHeight());
	OLE_COLOR ocColor = (OLE_COLOR)CommonOptionalLong(&Color, (long)GetForeColor());

	CommonDrawTextInRect(3, &rect, Text, ocColor);
}

long CS309PictureBox::GetHIcon() 
{
	return 0;
}

void CS309PictureBox::SetHIcon(long nNewValue) 
{
...
BOOL CS309PictureBox::GetAutoDetectTransparency() 
{
	return m_bAutoDetectTransparency;
}

void CS309PictureBox::SetAutoDetectTransparency(BOOL bNewValue) 
{
...
HBITMAP CS309PictureBox::CommonGetBitmapFromIcon(HICON hIcon, long xPassed, long yPassed, OLE_COLOR ocColorPassed, long nDrawType)
{
	HBITMAP hBitmap = NULL;
...
long CS309PictureBox::GetResourceIconHeight() 
{
	return m_nResourceIconHeight;
}

void CS309PictureBox::SetResourceIconHeight(long nNewValue) 
{
	if (0 > nNewValue)
	{
		ThrowError(CTL_E_INVALIDPROPERTYVALUE, IDS_STRINGVALUEOUTOFRANGE, 0);
...
long CS309PictureBox::GetResourceIconWidth() 
{
	return m_nResourceIconWidth;
}

void CS309PictureBox::SetResourceIconWidth(long nNewValue) 
{
	if (0 > nNewValue)
	{
		ThrowError(CTL_E_INVALIDPROPERTYVALUE, IDS_STRINGVALUEOUTOFRANGE, 0);
...
BOOL CS309PictureBox::CommonGetIconSize(HICON hIcon, long *lWidth, long *lHeight)
{
	long x = 0;
	long y = 0;
#ifdef UNDER_CE
