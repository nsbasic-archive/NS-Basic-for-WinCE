// S309HotKey.cpp : Implementation of CS309HotKeyApp and DLL registration.
...
CS309HotKeyApp NEAR theApp;

const GUID CDECL BASED_CODE _tlid =
		{ 0x95299e18, 0x49ef, 0x11d3, { 0xae, 0x2e, 0, 0x60, 0x8c, 0xc1, 0xdd, 0x62 } };
const WORD _wVerMajor = 1;
const WORD _wVerMinor = 3;


////////////////////////////////////////////////////////////////////////////
// CS309HotKeyApp::InitInstance - DLL initialization 

BOOL CS309HotKeyApp::InitInstance()
{
	BOOL bInit = COleControlModule::InitInstance();

/*	if (bInit)
	{
		COleDateTime dteExpire;
		COleDateTime dteDate;
		dteExpire.SetDateTime(2000, 7, 31, 23, 59, 59);
		dteDate = dteDate.GetCurrentTime();

		if (dteDate > dteExpire)
		{
			AfxMessageBox(_T("The beta S309.HotKey.1 Control has expired.\nGoto http://members.xoom.com/S309"), MB_ICONERROR + MB_OK, 0);
			bInit = false;
		}
	}
*/
...
////////////////////////////////////////////////////////////////////////////
// CS309HotKeyApp::ExitInstance - DLL termination

int CS309HotKeyApp::ExitInstance()
{
...
{
//	AfxMessageBox(_T("DllRegisterServer in s309hotkey.ocx called."), MB_OK, 0);
...
#ifndef UNDER_CE	
	TCHAR szControl[] = TEXT("S309.HotKey.1");  // this should be the only parameter to change
