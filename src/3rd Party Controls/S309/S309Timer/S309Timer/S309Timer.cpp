// S309Timer.cpp : Implementation of CS309TimerApp and DLL registration.
...
CS309TimerApp NEAR theApp;

const GUID CDECL BASED_CODE _tlid =
		{ 0xc993da3, 0x484a, 0x11d3, { 0xae, 0x2d, 0, 0x60, 0x8c, 0xc1, 0xdd, 0x62 } };
const WORD _wVerMajor = 1;
const WORD _wVerMinor = 5;


////////////////////////////////////////////////////////////////////////////
// CS309TimerApp::InitInstance - DLL initialization

BOOL CS309TimerApp::InitInstance()
{
...
////////////////////////////////////////////////////////////////////////////
// CS309TimerApp::ExitInstance - DLL termination

int CS309TimerApp::ExitInstance()
{
...
#ifdef _MIPS_
#if _WIN32_WCE < 300
//	AfxMessageBox(TEXT("S309Timer.ocx\r(c) Copyright 1999-2000 Software 309"), MB_OK, 0 );
...
#ifndef UNDER_CE	
	TCHAR szControl[] = TEXT("S309.Timer.1");  // this should be the only parameter to change
